...
def process (input_image, params, model_params, next_frame):
...
if __name__ == '__main__':
    ...
    if camera.isOpened():
        ...
        # out = cv2.VideoWriter('output.avi', -1, 1.0, (height,width))
        out = cv2.VideoWriter('output.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 1.0, (height,width))
        next_frame = 0
        ...
        for i in range(no_frames):
            ...
            canvas = (process(use_frame, params, model_params, next_frame))
            toc = time.time()
